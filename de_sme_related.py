# -*- coding: utf-8 -*-
"""de-sme_related.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-19LyCsTvjzzVML0afaLMv8A09C_kB7P
"""
...
sme = pd.read_csv('/content/drive/MyDrive/dataset/dataengineering/關於SME資訊與申請與點數_2022_1003_04.csv', header='infer')
#sme.head(5)
town = pd.read_csv('/content/drive/MyDrive/dataset/dataengineering/Taiwan_town-town.csv', header='infer')
town.head(5)
...
upload_blob('tcloud_bq_files','/content/sme_basic.csv','sme_basic.csv')
upload_blob('tcloud_bq_files','/content/sme_points.csv','sme_points.csv')
upload_blob('tcloud_bq_files','/content/sme_questionnaire.csv','sme_questionnaire.csv')

len(sme_basic)

len(sme_questionnaire)

sme1 = pd.read_csv('/content/drive/MyDrive/dataset/dataengineering/關於SME資訊與申請與點數_2022_1003_04.csv', header='infer')

sme_district = sme1[['統一編號', '公司名稱', '公司地址', '行業類別代碼', '行業大類代碼', '行業中類代碼', '行業小類代碼',
       '行業細類代碼', '行業子類代碼', '設立登記日期', '實收資本額', '員工人數', '異動日期', '狀態', '參考的解決方案','申請點數次數', '現有實際點數', '返還點數給平台', '點數狀態',
       'SME建立日期', '點數建立日期', '點數異動日期', '點數異動原因', '點數到期日期', '認證方式', '點數來源',
       '僅稅籍登記']]

sme_district['鄉政市區']=districtls

sme_district.head(5)

sme_district.to_csv('sme_district.csv')